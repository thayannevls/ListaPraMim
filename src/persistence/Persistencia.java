...
/**
 * Classe responsavel por conter metodos para salvar e carregar entidades em
 * arquivos. Usando padrao de projeto Singleton
 * 
...
public final class Persistencia {
	 ...
	 * 
	 * @return boolean true caso nao tenha sido criado nenhum arquivo, false o
	 *         contrario
	 */
	 ...
	 * 
	 * @param arquivo
	 *            arquivo que sera salvo o objeto
	 * @param objeto
	 *            objeto a ser salvo
	 * @throws IOException
