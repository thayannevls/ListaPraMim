...
public class ItemControllerTest {
	...
	public void listaItemOrdemAlfabetica() {
		...
		assertEquals(id1 + ". Agua Sanitaria Drogon, limpeza, 1 l, Preco: <Supermercado Excepcional, R$ 2,19;>", controller.getItem(0));
		assertEquals(id5 + ". Batata Tentacoes, alimento industrializado, Preco: <Supermercado Excepcional, R$ 3,79;>", controller.getItem(1));
	...
	public void listaItemPorCategoria() {
		...
		assertEquals(id9 + ". Costela suina Saara, alimento industrializado, Preco por quilo: <Supermercado UauMart, R$ 23,49;>", controller.getItemPorCategoria("alimento industrializado", 1));
		assertEquals(id2 + ". Peito de peru Saara, alimento industrializado, Preco por quilo: <Mercadinho Bem Barato, R$ 34,49;>", controller.getItemPorCategoria("alimento industrializado", 2));
		assertEquals(id3 + ". Queijo ralado Lebron, alimento industrializado, 50 grama, Preco: <Supermercado UauMart, R$ 1,59;>", controller.getItemPorCategoria("alimento industrializado", 3));
		...
		//limpeza
		assertEquals(id1 + ". Agua Sanitaria Drogon, limpeza, 1 l, Preco: <Supermercado Excepcional, R$ 2,19;>", controller.getItemPorCategoria("limpeza", 0));
	...
	public void listaItemPorMenorPreco() {
		...
		assertEquals(id3 + ". Queijo ralado Lebron, alimento industrializado, 50 grama, Preco: <Supermercado UauMart, R$ 1,59;>", controller.getItemPorMenorPreco(0));
		assertEquals(id1 + ". Agua Sanitaria Drogon, limpeza, 1 l, Preco: <Supermercado Excepcional, R$ 2,19;>", controller.getItemPorMenorPreco(1));
	...
	public void listaItemPorPesquisa() {
		...
		assertEquals(id1 + ". Alho poro, alimento nao industrializado, Preco: <Mercadinho Bem Barato, R$ 1,39;>", controller.getItemPorPesquisa("Alho", 1));
