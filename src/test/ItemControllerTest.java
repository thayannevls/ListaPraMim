...
public class ItemControllerTest {
	...
	public void exibeItemIdInexistente() {
		controller.adicionaItemPorUnidade("Talco PomPom", "higiene pessoal", 1, "Mercadinho DoBom", 4.80);
		controller.adicionaItemPorQtd("Creme de leite", "alimento industrializado", 190, "gramas", "Mercado do seu Zeh",
				1.80);
		controller.adicionaItemPorQuilo("Presunto Ceara", "alimento industrializado", 1.50, "Mercado Central", 9.00);

		controller.exibeItem(4);
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void atualizaItemInexistente() {
		int id1 = controller.adicionaItemPorQtd("Pimenta gota", "alimento industrializado", 200, "mililitro", "Super Mercado", 1.90);
		int id2 = controller.adicionaItemPorUnidade("Talco PomPom", "higiene pessoal", 1, "Mercadinho DoBom", 4.80);
		int id3 = controller.adicionaItemPorQuilo("Peito de flango", "alimento industrializado", 1.5, "Mercado do seu Zeh", 12.00);
		int id4 = controller.adicionaItemPorUnidade("Cotonetes", "higiene pessoal", 2, "Mercado Central", 1.99);
		
		controller.atualizaItem(5, "nome", "blablabla");
	}
	...
	public void atualizaItemAtributoInvalido() {
		...
		controller.atualizaItem(id3, "cheiro", "ovos");
	}
	...
	public void atualizaItemAtributoVazio() {
		...
		int id2 = controller.adicionaItemPorUnidade("Creme hidratante", "higiene pessoal", 2, "Supermercado Nice", 3.99);
		int id3 = controller.adicionaItemPorQtd("Leite Ninho", "alimento industrializado", 300, "gramas", "Mercadinho BomD+", 16.50);
		int id4 = controller.adicionaItemPorUnidade("Creme de barbear", "higiene pessoal", 3, "Mercado Central", 8.90);
		
		controller.atualizaItem(id2, "", "leitche");
	}
	...
	public void atualizaItemAtributoNull() {
		...
		controller.atualizaItem(id3, null, "banana");
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void atualizaItemNovoValorInvalido() {
		int id1 = controller.adicionaItemPorQuilo("Carne Freeboy", "alimento industrializado", 2.0, "Mercadinho BomD+", 27.00);
		int id2 = controller.adicionaItemPorUnidade("Creme hidratante", "higiene pessoal", 2, "Supermercado Nice", 3.99);
		int id3 = controller.adicionaItemPorQtd("Leite Ninho", "alimento industrializado", 300, "gramas", "Mercadinho BomD+", 16.50);
		int id4 = controller.adicionaItemPorUnidade("Creme de barbear", "higiene pessoal", 3, "Mercado Central", 8.90);
		...
		controller.atualizaItem(id2, "nome", null);
	...
	public void atualizaItemCategoriaNaoExiste() {
		...
		controller.atualizaItem(id4, "categoria", "comestiveis");
	...
	public void atuaizaItemUnidadeInvalida() {
		...
		controller.atualizaItem(id4, "unidades", "-4");
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void atualizaItemQtdInvalida() {
		int id1 = controller.adicionaItemPorQtd("Leite Ninho", "alimento industrializado", 300, "gramas", "Mercadinho BomD+", 16.50);
	...
	public void adicionaPrecoItemLocalDeCompraVazio() {
		...
		controller.adicionaPrecoItem(id2, "", 3.99);
	}
	...
	public void adicionaPrecoItemLocalDeCompraNull() {
		...
		controller.adicionaPrecoItem(id3, null, 5.99);
	}
	...
	public void adicionaPretoItemIdNegativo() {
		...
		controller.adicionaItemPorQtd("Azeite", "alimento industrializado", 300, "gramas", "Mercado do seu Zeh", 9.80);
		controller.adicionaItemPorQuilo("Queijo Mussarela", "alimento industrializado", 0.5, "Mercado Central", 9.00);
	...
	public void adicionaPrecoItemLocalVazio() {
		...
		controller.adicionaPrecoItem(2, "", 9.90);
	...
	public void adicionaPrecoItemLocalNull() {
		...
		controller.adicionaPrecoItem(2, null, 9.90);
	...
	public void adicionaPrecoItemPrecoInvalido() {
		...
		controller.adicionaItemPorQtd("Macarrao", "alimento industrializado", 150, "gramas", "Supermercado Nice", 1.99);
		controller.adicionaItemPorQuilo("Goiaba", "alimento nao industrializado", 2.0, "Mercado do seu Zeh", 2.80);

		controller.adicionaPrecoItem(3, "Mercado Central", -2.99);
	}
	...
	public void adicionaItemPorQuiloTest() {
		...
		assertEquals(
				id2 + ". Peito de flango, alimento industrializado, Preco por quilo: <Mercado do seu Zeh, R$ 12,00>",
	...
	public void adicionaItemPorQtdTest() {
		...
		int id2 = controller.adicionaItemPorQtd("Algodao do campo", "higiene pessoal", 150, "gramas",
	...
	public void adicionaItemPorUnidadeTest() {
		...
		int id2 = controller.adicionaItemPorUnidade("Creme de barbear", "higiene pessoal", "Mercado Central", 8.90);

		assertEquals(id1 + ". Creme hidratante, higiene pessoal, Preco: <Supermercado Nice, R$ 3,99>",
				controller.exibeItem(id1));
		assertEquals(id2 + ". Creme de barbear, higiene pessoal, Preco: <Mercado Central, R$ 8,90>",
				controller.exibeItem(id2));
	...
	public void exibeItensVariadosPeloId() {
		...
		int id3 = controller.adicionaItemPorQtd("Leite Ninho", "alimento industrializado", 300, "gramas", "Mercadinho BomD+", 16.50);
		int id4 = controller.adicionaItemPorUnidade("Creme de barbear", "higiene pessoal", 3, "Mercado Central", 8.90);
		int id5 = controller.adicionaItemPorQtd("Algodao do campo", "higiene pessoal", 2, "gramas", "Mercado do seu Zeh", 1.40);
		int id6 = controller.adicionaItemPorQuilo("Peito de flango", "alimento industrializado", 1.5, "Mercado do seu Zeh", 12.00);
		int id7 = controller.adicionaItemPorQuilo("Mortadela Sadia", "alimento industrializado", 0.5, "Supermercado Top", 4.99);
		...
		assertEquals(id6 + ". Peito de flango, alimento industrializado, Preco por quilo: <Mercado do seu Zeh, R$ 12,00",
	...
	public void atualizaItemPorQtdTest() {
		int id1 = controller.adicionaItemPorQtd("Talco para chuleh", "higiene pessoal", 250, "gramas", "Mercado Central", 6.80);
		assertEquals(id1 + ". Talco para chuleh, higiene pessoal, 150 gramas, Preco: <Mercado Central, R$ 6,80>", controller.exibeItem(id1));

		controller.atualizaItem(id1, "nome", "Talco para BB");
		controller.atualizaItem(id1, "quantidade", "200");

		assertEquals(id1 + ". Talco para BB, higiene pessoal, 200 gramas, Preco: <Mercado Central, R$ 6,80>", controller.exibeItem(id1));
	}
	
	@Test
	public void atualizaItemPorQuiloTest() {
		int id1 = controller.adicionaItemPorQuilo("Peito de flango", "alimento industrializado", 1.5, "Mercado do seu Zeh", 12.00);
		assertEquals(id1 + ". Peito de flango, alimento industrializado, Preco por quilo: <Mercado do seu Zeh, R$ 12,00", controller.exibeItem(id1));
		
		controller.atualizaItem(id1, "nome", "File Mignon");
		controller.atualizaItem(id1, "kg", "2.0");
		
		assertEquals(id1 + ". File Mignon, alimento industrializado, Preco por quilo: <Mercado do seu Zeh, R$ 12,00>", controller.exibeItem(id1));
	}
	...
	public void atualizaItemPorUnidadeTest() {
		...
		assertEquals(id1 + ". Creme de barbear, higiene pessoal, Preco: <Mercado Central, R$ 8,90>", controller.exibeItem(id1));
	...
	public void adicionaNovosPrecos() {
		...
		int id2 = controller.adicionaItemPorQtd("Azeite", "alimento industrializado", 300, "gramas", "Mercado do seu Zeh", 9.80);
		int id3 = controller.adicionaItemPorQuilo("Queijo Mussarela", "alimento industrializado", 0.5, "Mercado Central", 9.00);
		...
		assertEquals(id1 + ". Esmalte Risquei, higiene pessoa, Preco: <Mercadinho DoBom, R$ 3,80; Super Mercado, R$ 3,70>", controller.exibeItem(id1));
		assertEquals(id2 + ". Azeite, alimento industrializado, 300 gramas, Preco: <Mercado do seu Zeh, R$ 9,80; Supermercado Top, R$ 10,99>", controller.exibeItem(id2));
		assertEquals(id3 + ". Queijo Mussarela, alimento industrializado, Preco por quilo: <Mercado Central, R$ 9,00; Mercadinho BomD+, R$ 9,50>", controller.exibeItem(id3));
	...
	public void deletaItens() {
		...
		assertEquals("Erro na listagem de item: item nao existe.", controller.exibeItem(id1));
		
		controller.deletaItem(id3);
		assertEquals("Erro na listagem de item: item nao existe.", controller.exibeItem(id3));
	...
	public void deletaItens() {
		...
		controller.deletaItem(id2);
		assertEquals("Erro na atualizacao de item: item nao existe.", controller.atualizaItem(id2, "nome", "Azedo"));
		controller.deletaItem(id3);
		assertEquals("Erro na atualizacao de item: item nao existe.", controller.atualizaItem(id3, "nome", "Presunto defumado"));
